...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { deck_id: @deck.deck_id, deck_name: @deck.deck_name, user_id: @deck.user_id } }
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { deck_id: @deck.deck_id, deck_name: @deck.deck_name, user_id: @deck.user_id } }
